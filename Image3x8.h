...
class Image3x8 {
    const int32_t c_height;
    const int32_t c_width;
    const uint32_t c_offset;
    Pixel *m_colors;
...
public:
    ...
    // ACCESSORS
    [[nodiscard]] int32_t height() const { return c_height; }
    [[nodiscard]] int32_t width() const { return c_width; }
    [[nodiscard]] uint32_t offset() const { return c_offset; }
    [[nodiscard]] size_t size() const { return c_height * c_width; }
    [[nodiscard]] const Pixel *operator[](const int32_t row) const { return m_colors + c_width * row; }
